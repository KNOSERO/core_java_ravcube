...
@SpringBootTest(classes = {TestApplication.class, KafkaRollbackPublisherContainerTest.KafkaRollbackPublisherConfig.class})
class KafkaRollbackPublisherContainerTest {
    ...
    static class KafkaRollbackPublisherConfig {
        @Bean
        KafkaRollbackPublisher kafkaRollbackPublisher() {
            return new KafkaRollbackPublisher();
        }
    }

    static class KafkaRollbackPublisher extends DefaultKafkaRollbackPublisher<KafkaDomainEvent> {
    }
}
